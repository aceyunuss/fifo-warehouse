...
<?php } else if ($this->session->userdata('position') == "Purchase") { ?>
  <div class="row">
    <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Pesanan Pembelian</p>
                <h5 class="font-weight-bolder mb-0">
                  <?= $potot ?>
                </h5>
              </div>
  ...
  <?php } else if ($this->session->userdata('position') == "Kabag Produksi") { ?>
  <div class="row">
    <div class="col-xl-4 col-sm-6 mb-xl-0 mb-4">
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Permintaan Barang</p>
                <h5 class="font-weight-bolder mb-0">
                  <?= $reqtot ?>
                </h5>
              </div>
