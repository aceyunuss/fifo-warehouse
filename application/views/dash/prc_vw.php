    ...
    <div class="card mb-4">
      ...
      <div class="card-body px-0 pt-0 pb-2">
        <div class="table-responsive p-0">
          <table id="todobpb" class="table align-items-center mb-0">
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Item Category</th>
  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        <div class="row">
          <div class="col-6 d-flex align-items-center">
            <h6 class="mb-0">List Permintaan Pembelian</h6>
          </div>
        </div>
      </div>
      <div class="card-body px-0 pt-0 pb-2">
        <div class="table-responsive p-0">
          <table id="todo" class="table align-items-center mb-0">
            <thead>
              <tr>
                <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">PR No</th>
                <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">PR Date</th>
                <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Status</th>
                <th class="text-uppercase text-center text-secondary text-xxs font-weight-bolder opacity-7">Aksi</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($prtodo as $key => $value) { ?>
                <tr class="text-center">
                  <td>
                    <p class="text-sm mb-0"><?= $value['pr'] ?></p>
                  </td>
                  <td>
                    <p class="text-sm mb-0"><?= $value['pr_date'] ?></p>
                  </td>
                  <td>
                    <p class="text-sm mb-0"><?= $value['status'] ?></p>
                  </td>
                  <td>
                    <a href="<?= site_url('pr/process/' . $value['id']) ?>" class="badge badge-sm bg-gradient-success">Proses</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="card-header pb-0">
        <div class="row">
          <div class="col-6 d-flex align-items-center">
            <h6 class="mb-0">Riwayat Permintaan Pembelian</h6>
          </div>
        </div>
      </div>
      <div class="card-body px-0 pt-0 pb-2">
            ...
            <tbody>
              <?php foreach ($pr as $key => $value) { ?>
                <tr class="text-center">
                  ...
                  <td>
                    <a href="<?= site_url('pr/view/' . $value['id']) ?>" class="badge badge-sm bg-gradient-success">Lihat</a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
