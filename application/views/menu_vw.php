<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="<?= site_url() ?>">
      <img src="<?= site_url('assets/img/multi.png') ?>" class="navbar-brand-img h-10" alt="main_logo">
      <span class="ms-0 font-weight-bold">Multi Optima Sejahtera</span>
    </a>
  </div>
  ...
  <div class="" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item spk">
        <a class="nav-link  " href="<?= site_url('spk') ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item pr">
        <a class="nav-link  " href="<?= site_url('pr') ?>">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Permintaan Pembelian</span>
        </a>
      </li>
...
<script>
  ...
  switch (pos) {
    case "Admin Gudang":
      ...
      break;
    case "PPIC":
      $('.rp, .rg, .po, .laporan').hide();
      break;
    case "Purchase":
      $('.rp, .rg, .pr, .spk, .laporan').hide();
      break;
    case "Kabag Produksi":
      $('.rg, .pr, .spk, .po, .laporan').hide();
    break;
  }
</script>